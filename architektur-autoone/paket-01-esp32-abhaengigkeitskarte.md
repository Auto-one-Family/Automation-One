...
- **Beschreibung:** Die RTOS-Architektur erfordert exakt 4 Queues für Cross-Core-Kommunikation. Jede Queue hat ein festes Memory-Budget (Publish: **10** Slots ~22 KB, SSOT `El Trabajante/src/tasks/publish_queue_constants.h` `PUBLISH_QUEUE_SIZE`; früher 8/AUT-362, historisch 15/AUT-344; AUT-481 P3. Config: 5 Slots ~20KB, Actuator: 10 Slots, Sensor: N Slots).
