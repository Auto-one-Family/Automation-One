...
export const useDashboardStore = defineStore('dashboard', () => {
  ...
  function serverToLocal(dto: DashboardDTO): DashboardLayout {
    return {
      ...
      target: (dto as any).target as DashboardTarget | undefined,
    }
  }
  ...
  function generateZoneDashboard(zoneId: string, devices: { sensors?: { gpio: number; sensor_type: string; name?: string | null }[]; actuators?: { gpio: number; actuator_type?: string; name?: string | null }[] }[], zoneName: string): DashboardLayout | null {
    ...
    type SensorEntry = { gpio: number; sensorType: string; name: string | null; category: SensorCategoryId }
    type ActuatorEntry = { gpio: number; actuatorType: string; name: string | null }
