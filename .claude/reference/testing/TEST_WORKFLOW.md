...
# ESP32 Serial Monitor (Git Bash: zeitbegrenzt, PowerShell: interaktiv mit Ctrl+C)
cd "El Trabajante" && timeout 30 ~/.platformio/penv/Scripts/pio.exe device monitor -e esp32_dev
```
