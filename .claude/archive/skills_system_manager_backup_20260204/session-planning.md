...
Dieser Skill kann folgende Subagents zur Detail-Analyse aktivieren:
...
### Delegation-Beispiele

```
# Für Boot-Analyse
> Use the esp32-debug subagent to analyze boot sequence from the serial log

# Für DB-Status
> Have db-inspector check how many ESPs are registered and their provisioning status

# Für MQTT-Monitoring
> Use mqtt-debug to start monitoring all kaiser/# topics
```
