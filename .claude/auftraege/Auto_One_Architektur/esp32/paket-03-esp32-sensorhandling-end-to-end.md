...
5. **Publish:**
   - Core 1: enqueue `g_publish_queue` (Tiefe 10, `PUBLISH_QUEUE_SIZE` in `publish_queue_constants.h`; non-blocking).
   - Core 0: `processPublishQueue()` ruft `esp_mqtt_client_publish` (adaptive Drain 1–2/Tick, AUT-481 P3).
