...
description: |
  Analysiert ESP32 Provisioning-Probleme für AutomationOne Debug-Sessions.
  MUST BE USED when: ESP32 not connecting, AP-Mode issues, WiFi configuration problems,
  MQTT broker connection failures, NVS configuration issues, Zone assignment failures,
  device discovery problems, captive portal issues.
  Proactively analyze ALL THREE logs when debugging provisioning.
...
> **Version:** 2.0 | **Fokus:** Provisioning & Connectivity Flow
...
```
1. LOG-VALIDIERUNG durchführen (Section 4.1)
...
### 4.1 Log-Validierung (KRITISCH - IMMER ZUERST!)
...
| Heartbeat gesendet, Server sieht nichts | **Log-Symlink veraltet** | Fallback-Pfad verwenden (Section 4.1) |
