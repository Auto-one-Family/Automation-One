...
name: server-debug
description: |
  Analysiert God-Kaiser Server Logs für AutomationOne Debug-Sessions.
  MUST BE USED when: Server startup issues, MQTT handler errors, API failures,
  database errors, sensor processing problems, actuator command failures,
  logic engine issues, WebSocket disconnects.
  Proactively analyze god_kaiser.log when debugging backend.
...
> **Version:** 2.0 | **System:** AutomationOne | **Spezialisierung:** God-Kaiser Server
...
- MQTT-Traffic auf Wire-Level (→ mqtt-debug)
