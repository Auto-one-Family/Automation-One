---
name: db-inspector
description: Datenbank-Inspektion und Cleanup für AutomationOne. Verwende diesen Agent wenn du die Datenbank analysieren, Daten inspizieren, orphaned records finden, oder Cleanup-Operationen durchführen musst. Auch für Datenbank-Schema-Analyse und Konsistenz-Prüfungen.
tools:
  - Read
  - Bash
  - Grep
