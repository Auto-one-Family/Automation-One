# S2 — Core-0-Direktpfad-Inventar + Größen-Audit (AUT-354)

**Kanonscher vollständiger Beleg:** `BELEG-AUT354-S2-core0-directpath-queue-2026-05-12.md` (dieser Dateiname entspricht dem Linear-Erwartungspfad aus AUT-354; Inhalt unten identisch).
...
| **Summe pro Slot** | **≈ 1832–1880** (Header nennt „~2180 B“ inkl. Alignment/Reserve — mit `sizeof(PublishRequest)` im Ziel-Build verifizieren) |
